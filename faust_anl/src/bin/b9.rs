...
fn main() {
    ...
    let e_rel_mod = RelativeEnergy::new().with_particles(1, 1, 1).with_particles(2, 2, 4);
    let e_rel_mod_mixed = RelativeEnergy::new().with_particles(1, 1, 1).with_particles(2, 2, 4);
